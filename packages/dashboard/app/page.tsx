...
const findingsData: FindingCard[] = [
  {
    ...
    evidencePath: {
      ...
      graphEdgesTraversed: ['DRG Coding Distribution → Average Reimbursement', 'MCC Tier Rate → DRG Coding Distribution', 'MCC Tier Rate → DRG Coding Distribution [upcoding]'],
  ...
  },
  {
    ...
    hypotheses: [
      ...
      },
      {
        ...
        score: 0.60,
        rationale: 'Patient mix may be sicker than peers, partially explaining the elevated readmission rate. Recommend comorbidity-adjusted comparison.',
    ...
    evidencePath: {
      ...
      graphEdgesTraversed: ['Patient Acuity → 30-Day Readmission Rate', '30-Day Readmission Rate → Average Reimbursement'],
  ...
  },
  {
    ...
    evidencePath: {
      ...
      graphEdgesTraversed: ['ER Visit Volume → Provider Peer Group [geographic_spike]', 'ER Visit Volume → 30-Day Readmission Rate [geographic_spike]'],
